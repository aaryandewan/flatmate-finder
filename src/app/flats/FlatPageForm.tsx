...
export default function FlatsPageForm({ user }: { user: any }) {
  const { data: session } = useSession();
  //   const defaultCity = user.location;
  const [defaultCity, setDefaultCity] = useState(user.location);
